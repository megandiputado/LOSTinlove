...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '../img/slider-images/image01.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''},
											{image : '../img/slider-images/image02.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''},
											{image : '../img/slider-images/image03.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''},
											{image : '../img/slider-images/image04.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''}  
									],
