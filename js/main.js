...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/image01.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image02.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image03.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image04.jpg', title : '<div class="slide-content">Lory and Simon tie the knot!</div>', thumb : '', url : ''}  
									],
...
CHAKRA.map = function(){
	if($('.map').length > 0)
	{
		...
		$('.map').each(function(i,e){
			...
			var contentString = '<p><strong>Crumbs & Creations</strong><br>Address here</p>';
